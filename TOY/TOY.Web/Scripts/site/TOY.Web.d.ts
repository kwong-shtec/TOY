...
declare namespace TOY.Administration {
}
declare namespace TOY.Administration {
...
declare namespace TOY.BasicSamples {
...
declare namespace TOY.Common.Pages {
...
declare namespace TOY.Membership {
...
declare namespace TOY.Modules.MovieDB.Movie {
    enum MovieKind {
        Film = 1,
        TvSeries = 2,
        MiniSeries = 3,
...
declare namespace TOY.Northwind {
}
declare namespace TOY.Northwind {
...
declare namespace TOY.Organization {
}
declare namespace TOY.Organization {
...
declare namespace TOY.Authorization {
...
declare namespace TOY.BasicSamples.DialogBoxes {
...
declare namespace TOY.DialogUtils {
...
declare namespace TOY.LanguageList {
...
declare namespace TOY.ScriptInitialization {
}
declare namespace TOY.Common {
